import {navbar,search,up_angle,down_angle,id,keys} from "../modules/variables.js";
...
prev.addEventListener('click',()=>{
  let url = `https://api.giphy.com/v1/gifs/${keys[--current]}?api_key=EhZIr1LNpPT7Hy9tS0iDuSFsUMVkfwNj`;
